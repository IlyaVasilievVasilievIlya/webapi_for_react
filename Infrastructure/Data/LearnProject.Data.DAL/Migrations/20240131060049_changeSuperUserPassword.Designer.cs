...
namespace LearnProject.DAL.Migrations
{
    ...
    [Migration("20240131060049_changeSuperUserPassword")]
    partial class changeSuperUserPassword
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LearnProject.Domain.Entities.RefreshToken", b =>
                {
            ...
            modelBuilder.Entity("LearnProject.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "941e3423-e7b4-4e7c-a397-61ba5b7e993f",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEJfBCBz0CcYDw9wyDgiqJNlCbqqISolvb5y2xTO+Gsuk7NDdeKm3XltgXOgKEGIZXA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "c9f83eb4-9c17-4f16-9ea8-519cb0665806",
                            Surname = "Ivanov",
            ...
            modelBuilder.Entity("LearnProject.Domain.Entities.RefreshToken", b =>
                {
                    b.HasOne("LearnProject.Domain.Entities.User", "User")
                        .WithOne()
                        .HasForeignKey("LearnProject.Domain.Entities.RefreshToken", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
