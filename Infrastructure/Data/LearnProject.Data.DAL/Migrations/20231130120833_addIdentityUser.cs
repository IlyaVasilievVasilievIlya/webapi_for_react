    ...
    public partial class addIdentityUser : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameIndex(
                ...
                table: "cars",
                newName: "ix_cars_car_model_id");

            migrationBuilder.AlterTable(
                name: "cars",
                oldComment: "car table");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_car_brand_models", x => x.car_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<string>(type: "text", nullable: false),
                    name = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false, comment: "user name"),
                    surname = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false, comment: "user surname"),
                    patronymic = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true, comment: "user patronymic"),
                    birth_date = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, comment: "user birth date"),
            ...
            migrationBuilder.AddForeignKey(
                name: "fk_cars_car_brand_models_car_model_id",
                table: "cars",
                column: "car_model_id",
                principalTable: "car_brand_models",
