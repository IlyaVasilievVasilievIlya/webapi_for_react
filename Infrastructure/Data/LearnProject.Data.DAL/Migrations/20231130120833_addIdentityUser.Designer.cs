...
namespace LearnProject.DAL.Migrations
{
    ...
    [Migration("20231130120833_addIdentityUser")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LearnProject.DAL.Entities.Car", b =>
                {
            ...
            modelBuilder.Entity("LearnProject.DAL.Entities.CarModel", b =>
                {
                    b.Property<int>("CarModelId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("LearnProject.DAL.Entities.User", b =>
                {
            ...
            modelBuilder.Entity("LearnProject.DAL.Entities.Car", b =>
                {
                    b.HasOne("LearnProject.DAL.Entities.CarModel", "CarModel")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("LearnProject.DAL.Entities.User", null)
                        .WithMany()
